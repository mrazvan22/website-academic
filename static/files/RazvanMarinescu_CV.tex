...
2014 & \large\textbf{PhD, Department of Computer Science, University College London}\\
...
2012 & \large\textbf{Summer Internship at Goldman Sachs, Equities Technology}\\
 & \emph{Built programmes that automatically re-factored the Java source-code of a trading system. Learned about financial instruments and live market data.}\\
...
\begin{itemize}
\subsection*{2020}
\item[\poster] \textbf{Marinescu, R.V.}, Young, A.L., Show, don't tell. Brain visualisations for neuroimaging studies
...
\begin{itemize}
\subsection*{2020}
\item[\poster] Slator, P., Hutter, J., \textbf{Marinescu, R. V.}, Palombo, M., Jackson, L., Ho, A., Chappell, L., Rutherford, M., Hajnal, J. and Alexander, D., 2020. Data-Driven Multi-Contrast Spectral Microstructure Imaging with InSpect, MICCAI.
\subsection*{2019}
...
\begin{itemize}
\item[\journal]  \textbf{Marinescu, R.V.} et al, The Alzheimer's Disease Prediction Of Longitudinal Evolution (TADPOLE) Challenge: Results after 1 Year Follow-up, in preparation
\end{itemize}
